...
>
    ...
    {#if $globalState.isSidebarOpen}
        ...
        >
            <div
                class="h-12 flex items-center px-4 border-b border-slate-800/30"
            >
                <span
            ...
            <div class="flex-1 overflow-y-auto py-2">
                <div class="px-2 mb-2">
                    <div
                        class="flex items-center gap-1 text-slate-400 px-2 py-1 hover:bg-white/5 rounded cursor-pointer transition-colors"
                    >
                        <ChevronRight size={14} />
                        <span class="text-sm font-bold truncate"
                            >SOVEREIGN-PLATFORM</span
                        >
                    </div>
                </div>
                <div class="space-y-0.5">
                    {#each files as file}
                        <button
                            ...
                            class="w-full flex items-center gap-2 px-6 py-1.5 text-sm transition-colors group {activeFile ===
                            file.name
                        ...
                        >
                            <file.icon
                                size={16}
                                class="shrink-0 {activeFile === file.name
                                    ? 'text-indigo-400'
                                    : 'text-slate-500'}"
                            />
            ...
            >
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        >
                        <button
                            class="text-xs font-bold text-slate-500 hover:text-slate-300 transition-colors h-9 flex items-center px-2"
                            >Output</button
                        >
                        <button
                            class="text-xs font-bold text-slate-500 hover:text-slate-300 transition-colors h-9 flex items-center px-2"
                ...
                <div
                    class="flex-1 p-4 font-mono text-[13px] overflow-y-auto custom-scrollbar"
                >
                    <div class="flex gap-2 mb-1">
                        <span class="text-emerald-500">➜</span>
                        <span class="text-indigo-400">sovereign-platform</span>
                        <span class="text-slate-500">git:(</span><span
                            class="text-rose-400">main</span
                        ><span class="text-slate-500">)</span>
                        <span class="text-white">npm run dev</span>
                    </div>
                    <div class="text-slate-400 mb-1">
                        Building Sovereign UI Core...
                    </div>
                    <div class="text-slate-400 mb-1">
                        Modules built: chat, vault, projects, rag, coding.
                    </div>
                    <div class="text-emerald-400 mb-1 font-bold">
                        ✔ Compilation success. Local server running at
                        http://localhost:5173
                    </div>
